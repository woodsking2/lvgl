...
void lv_style_init(void)
{
    ...
    lv_style_scr.text.color        = lv_color_make(0xFF - 0x30, 0xFF - 0x30, 0xFF - 0x30);
    lv_style_scr.text.sel_color    = lv_color_make(0xFF - 0x55, 0xFF - 0x96, 0xFF - 0xd8);
    ...
    lv_style_scr.image.color   = lv_color_make(0xFF - 0x20, 0xFF - 0x20, 0xFF - 0x20);
    lv_style_scr.image.intense = LV_OPA_TRANSP;
    lv_style_scr.image.blend_mode = LV_BLEND_MODE_NORMAL;

    lv_style_scr.line.opa     = LV_OPA_COVER;
    lv_style_scr.line.color   = lv_color_make(0xFF - 0x20, 0xFF - 0x20, 0xFF - 0x20);
